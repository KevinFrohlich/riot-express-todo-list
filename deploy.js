...
function transferProjectToRemote(failed, successful) {
	return ssh.putDirectory('../riot-express-todo-list', '/home/ubuntu/riot-express-todo-list-temp', {
		recursive: true,
		concurrency: 1,
...
function createRemoteTempFolder() {
	return ssh.execCommand('rm -rf riot-express-todo-list-temp && mkdir riot-express-todo-list-temp', {
		cwd: '/home/ubuntu'
	});
}
...
function restartRemoteServices() {
	return ssh.execCommand('cd riot-express-todo-list && sudo service mongod start && pm2 start app.js', {
		cwd: '/home/ubuntu'
	});
}
